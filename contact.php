...
<html lang="en">
<head>
    <title>Green land - contact us</title>
    <meta charset="utf-8">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-item d-flex align-items-start" href="#">
                    ...
                    <div class="text pl-3">
                        ...
                        <p class="mb-0"><a href="#" class="price">ksh 3,500</a><span class="quantity ml-3">Quantity: 02</span></p>
                    </div>
                </div>
                <div class="dropdown-item d-flex align-items-start" href="#">
                    ...
                    <div class="text pl-3">
                        <h4>Citadelle</h4>
                        <p class="mb-0"><a href="#" class="price">ksh 2,600</a><span class="quantity ml-3">Quantity: 01</span></p>
                    </div>
                </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Address:</span>211 Green land plaza,St. Moi avenue, Nairobi, Kenya </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Phone:</span> <a href="tel://1234567920">+254 705 553 860</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Email:</span> <a href="mailto:dianaauma2@gmail.com.com">dianaauma2@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Website</span> <a href="index.php">greenland.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row no-gutters">
                        <div class="col-md-7">
                            <div class="contact-wrap w-100 p-md-5 p-4">
                                <h3 class="mb-4">Contact Us To Book A Table</h3>
                                <?php
                                $Msg = "";
                                if (isset($_GET['error'])) {
                                ...
                                ?>
                                <form method="POST" action="process.php" id="contactForm" name="contactForm" class="contactForm">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="msg" class="form-control"  cols="30" rows="4" placeholder="Message"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
